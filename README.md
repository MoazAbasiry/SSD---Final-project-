...
[cite_start]We used **OWASP ZAP 2.16.1** to establish a baseline of the security posture[cite: 17].
...
[cite_start]Using **Postman**, we manually verified 8 critical vulnerabilities (V1 to V8) identified during the reconnaissance phase[cite: 19].
...
[cite_start]*Figure 2: Mass data disclosure via SQL Injection[cite: 66].*
...
[cite_start]*Figure 3: Server-Side Template Injection results[cite: 117].*
...
[cite_start]We authored custom rules to demonstrate advanced detection capabilities[cite: 312].

![Custom Rules Detection](./Screenshots/custom_rules_initial.png)
[cite_start]*Figure 5: Custom Semgrep rules identifying specific project vulnerabilities[cite: 313].*
...
[cite_start]*Figure 7: Final SAST validation confirming clean codebase for custom rules[cite: 490].*
